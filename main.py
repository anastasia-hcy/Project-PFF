...
for i in range(nD):
    ax[0,0].plot(X1[:,i], linewidth=1, alpha=0.5, color="green") 
    ax[0,0].plot(Y1[:,i], linewidth=1, alpha=0.5, color="orange", linestyle='dashed') 
for i in range(nD):
    ax[0,1].plot(X[:,i], linewidth=1, alpha=0.5, color="green") 
    ax[0,1].plot(Y[:,i], linewidth=1, alpha=0.5, color="orange", linestyle='dashed') 
for i,j in zip(observed,range(Ny)):
    ax[1,0].plot(X1_sparse[:,i], linewidth=1, alpha=0.5, color="green") 
    ax[1,0].plot(Y1_sparse[:,j], linewidth=1, alpha=0.5, color="orange", linestyle='dashed') 
for i in unobserved:
    ax[1,0].plot(X1_sparse[:,i], linewidth=1, alpha=0.5, color="green") 
for i,j in zip(observed,range(Ny)):
    ax[1,1].plot(X_sparse[:,i], linewidth=1, alpha=0.5, color="green") 
    ax[1,1].plot(Y_sparse[:,j], linewidth=1, alpha=0.5, color="orange", linestyle='dashed') 
for i in unobserved:
    ax[1,1].plot(X_sparse[:,i], linewidth=1, alpha=0.5, color="green") 
plt.tight_layout()
plt.show()
