...
class KalmanFilter: 
    ...
    def run(self, *, y, model=None, A=None, B=None, V=None, W=None, mu0=None, mu=None):     
        """Run the Standard Kalman Filter and return the filtered states, X_filtered.""" 
...
class ExtendedKalmanFilter: 
    ...
    def run(self, *, y, model=None, A=None, B=None, V=None, W=None, mu0=None, mu=None):        
        "Run the Extended Kalman Filter and return the filtered states, X_filtered."
...
class UnscentedKalmanFilter: 
    ...
    def Propagate(self, model, ndims, X_sp, B):
    ...
    def Predict_crosscov(self, ndims, weight0c, weighti, SP, mean, SP2, mean2, u):
    ...
    def Predict(self, model, ndims, xpred, Ppred, w0m, w0c, wi, Lamb, A, B, W, U):
        ...
        Y_sp            = self.Propagate(model, ndims, Xpred_sp, B) 
        y_pred          = self.Predict_mean(w0m, wi, Y_sp)
        W_pred          = self.Predict_cov(ndims2, w0c, wi, Y_sp, y_pred, U, Cov=W)
        C_pred          = self.Predict_crosscov(ndims2, w0c, wi, Xpred_sp[:,:ndims], x_pred0[:ndims], Y_sp, y_pred, U) 
    ...
    def run(self, *, y, model=None, A=None, B=None, V=None, W=None, mu0=None, mu=None):        
        """Run the Unscented Kalman Filter and return the filtered states, X_filtered."""
        ...
        for i in range(self.nTimes):
            ...
            SP                      = self.SigmaPoints(self.ndims, x_prev, P_prev, L)
