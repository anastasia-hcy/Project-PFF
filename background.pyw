...
from scripts import norm_rvs, LEDH, SDE
...
if __name__ == '__main__':
    ...
    p2 = multiprocessing.Process(target=background_task, args=(Y1, Ns, pathdat,))
    p2.start()
    
    p3 = multiprocessing.Process(target=background_task2, args=(Y1, Ns, pathdat,))
    p3.start()
